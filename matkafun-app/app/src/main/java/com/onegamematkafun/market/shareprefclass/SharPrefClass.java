package com.onegamematkafun.market.shareprefclass;

import android.content.Context;
import android.content.SharedPreferences;

public class SharPrefClass {
    private static final String PREF_NAME = "kalyan_market_pref";
    // KEY
    public static final String KEY_ADD_COIN_BONUS = "add_coin_bonus_percent";

    // SAVE
    public static void setAddCoinBonus(Context c, String value) {
        SharedPreferences sp = c.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        sp.edit().putString(KEY_ADD_COIN_BONUS, value).apply();
    }

    // GET
    public static String getAddCoinBonus(Context c) {
        SharedPreferences sp = c.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
        return sp.getString(KEY_ADD_COIN_BONUS, "0");
    }
    ...
    public static String KEY_WITHDRAW_OPEN_TIME = "withdrawOpenTime";
    public static String KEY_WITHDRAW_CLOSE_TIME = "withdrawCloseTime";
    ...
    public static String KEY_SELECTED_LANGUAGE = "SelectedLanguage";
    public static String KEY_IS_LANGUAGE_SET = "IsLanguageSet";
    ...
    public static boolean getPreferenceBooleanData(Context context, String key, boolean defaultValue) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("MyPref", Context.MODE_PRIVATE);
        return sharedPreferences.getBoolean(key, defaultValue);
    }
