...
import com.onewonderclub.market.responseclass.DataDesawarList;
...
import com.onewonderclub.market.responseclass.DataValue;
import com.onewonderclub.market.responseclass.DataPlayTraining;
import com.onewonderclub.market.responseclass.DataStarlineWin;
import com.onewonderclub.market.responseclass.DataVerifyTransferCoin;
import com.onewonderclub.market.responseclass.DataProfileStatus;
import com.onewonderclub.market.responseclass.UpdateResponse;
...
public interface ApiInterface {
    ...
    @FormUrlEncoded
    @POST(ApiUrls.top_winners)
    Call<com.onewonderclub.market.responseclass.DataTopWinners> getTopWinners(
            @Header("token") String token,
            @Field("string") String string
    );

    @retrofit2.http.GET
    Call<UpdateResponse> getInAppUpdate(
