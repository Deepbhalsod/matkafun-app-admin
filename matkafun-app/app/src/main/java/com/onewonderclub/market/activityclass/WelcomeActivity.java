...
import com.onewonderclub.market.apiclass.UpdateChecker;
...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Check for updates
        new UpdateChecker(this, "https://wonder1club.click/version.json", new UpdateChecker.OnUpdateFinishedListener() {
            @Override
