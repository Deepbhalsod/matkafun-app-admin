...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private static final java.lang.String WHATSAPP_LINK = "https://wa.me/+917568235319";
    Utility utility;
    ...
    public void signUp(View view) {
        ...
        if (YourService.isOnline(this))
            SignUpMethod(this ,mInName.getText().toString().trim(), mIMobNum.getText().toString().trim(), mInPass.getText().toString().trim(), "1234");
    ...
    private void ContactUs() {
        try {
            ...
            // Parse the WhatsApp URL into a Uri object
            ...
            // Start the activity to open the WhatsApp link
