...
import com.onewonderclub.appm.appm.responseclass.DataPlaying;
...
public class PlayingActivity extends AppCompatActivity {
    ...
    public void proceedConformBtn(View view) {
        ...
        com.onewonderclub.appm.appm.shareprefclass.MBSFragment MBSFragment = new MBSFragment(new MBSFragment.OnConformClick() {
            @Override
