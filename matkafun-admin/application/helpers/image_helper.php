...
if (!function_exists('file_input')) {
	 ...
	 * @return void */
	function file_input(string $nameContainer = null, bool $require = true, $oldImagePath = null, string $ImageHeight = "60", string $ImageWidth = "80", bool $MultipleImages = false)
	{
		...
		<div class="row">
			<div class="col-12 <?php is_array($oldImagePath) or print('col-md-2') ?> mb-4" id="place-<?php echo $nameContainer; ?>">
				...
				<?php else : ?>
					...
					<?php vars_exists($ImageHeight) and print($ImageHeight); ?>px" style="width:<?php vars_exists($ImageWidth) and print($ImageWidth); ?>">
					</div>
				<?php endif; ?>
			</div>
