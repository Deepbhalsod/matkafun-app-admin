...
if (!function_exists('is')) {
	...
	function is(&$param = null, ?string $action = null)
	{
		...
		} elseif (!is_null($action) and $action === 'time') {
			return isset($param) and $param !== false and $param != '' and !empty($param) and print(_time_format($param));
...
if (!function_exists('is_login')) {
	...
	function is_login()
	{
		return is($_SESSION['USER_ROLE']) and is($_SESSION['LOGIN']) and is($_SESSION['USER_ID']) and  is($_SESSION['USER_NAME']);
	}
}
