                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select name="status" id="status" class="selectpicker form-control">
                                <option value="2" <?= ($stareeee->status == '2') ? 'selected' : ''; ?>>Inactive</option>
                                <option value="1" <?= ($stareeee->status == '1') ? 'selected' : ''; ?>>Active</option>
                            </select>
                        </div>
                    </div>

                    <button class="btn btn-success mt-3" name="changeRatingsStatus" value="sdf" type="submit">Update Ratings Status</button>
                </form>
