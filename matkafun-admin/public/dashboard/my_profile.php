                    ...
                    <div class="card  mt-3">
                        <div class="d-flex flex-column align-items-center text-center">
                            <?php if ($admin['profile'] != '') { ?>
                                <img src="<?php echo $admin['profile'] ?>" alt="Admin" class="rounded-circle" width="150">
                            <?php } else { ?>
                            ...
                            <div class="mt-3">
                                ...
                                <p class="text-secondary mb-1"><?php echo $admin['designation'] ?></p>
                                <!-- <p class="text-muted font-size-sm"><?php echo $admin['address'] ?></p> -->
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="card mb-10">
                    <div class="card-body-profile">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <h6 class="mb-0"><b><a href="<?php echo SITE_URL ?>dashboard/change_pass">Change Password</a></b></h6>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-3">
                                    <button type="submit" name="addAdminImg" value="sfddsfs" class="btn btn-primary">Submit</button>
                                </div>
                            </form>
                        </div>
                        <hr>
