...
<?php breadcrumb_start('ratings', 'add/ratings', 'ratings_add'); ?>
            ...
            <form method="post">
                <div class="table-responsive mb-4 mt-4">
                    <table id="multi-column-ordering" class="style-3 table table-hover" style="width:100%">
                        ...
                        <tbody>
                            <?php $i = 1;
                            if (!empty($ratingsData) and !empty($ratingsData->data)) :

                                foreach ($ratingsData->data as $key => $value) :
                            ?>
                                    <tr>
                                        <td><?php echo $i++; ?>.</td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        ...
                                                        <?php if ($value->status == 1) { ?>
                                                            <li><a href="<?= SITE_URL; ?>Ratings/change_status_ratings/<?= $value->id; ?>/inactive">Inactive</a></li>
                                                        <?php } else { ?>
                                                            <li><a href="<?= SITE_URL; ?>Ratings/change_status_ratings/<?= $value->id; ?>/active">Active</a></li>
                                                        <?php        }   ?>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <ul class="table-controls">
                                                <li>
                                                    <a href="<?php echo SITE_URL . 'edit/ratings/' . $value->id;  ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
                                                ...
                                                <?php if (user_can('ratings_delete')) : ?>
                                                    <li>
                                                        <a class="deleteConfirm" data-delete-url="<?php echo SITE_URL . 'delete/ratings/' . $value->id; ?>">
