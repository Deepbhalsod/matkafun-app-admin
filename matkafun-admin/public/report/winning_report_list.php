            ...
            <form class="p-3" method="POST" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-md-2 text-centre">
                        ...
                        <button class="btn btn-danger" id="clearrr_cat" style="color:azure; margin-top:30px;"><a href=" <?= SITE_URL; ?>winning_report_list/report">Clear</a></button>
                    </div>
                </div>
            </form>
            <form method="post">
                        ...
                        <tbody class="text-center">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?=date('d-m-Y h:i A', strtotime($value['won_at']))?></td>
                                        <td class="text-center"><a href="<?php echo SITE_URL . 'user_detail_list/user/' . $value['user_id'];  ?>"><?=$value['user_mobile']?></a></td>
                                        ...
                                        <td class="text-center"><?=$value['win_points']?></td>
