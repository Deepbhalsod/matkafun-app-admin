						...
						<?php if (!empty($userData)) :
							...
							foreach ($userData as $key => $value) : ?>
								<tr>
									...
									<td><?php echo $value->available_points; ?></td>
									<td><span class="badge outline-badge-danger">No</span></td>
									<td>
									    <?php if($value->status==1)
									    {?>
									    <a href="<?= SITE_URL; ?>User/change_status_user/<?= $value->id; ?>/inactive"><span class="badge px-2 py-1 badge-success">Active</span></a>
									    <?php }else if($value->status==2){?>
									    <a href="<?= SITE_URL; ?>User/change_status_user/<?= $value->id; ?>/active"><span class="badge px-2 py-1 badge-danger">Inactive</span></a>
									    <?php }?>
									</td>
									<td>
