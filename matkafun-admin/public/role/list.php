										...
										<td class="text-center">
											<ul class="table-controls">
												...
												<?php if (user_can('user-role_delete')) : ?>
													<li>
													<a class="deleteConfirm bs-tooltip" data-delete-url="<?php echo SITE_URL . 'delete/user-role/' . $value->id; ?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
