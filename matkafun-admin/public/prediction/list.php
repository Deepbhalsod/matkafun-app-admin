                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group mb-4 reloaded-divs">
                            ...
                            <select class="selectpicker form-control" name="open_panna" title="Select Panna" id="pre_open_pana" value="">
                    ...
                    <div class="col-md-2">
                        <div class="form-group mb-4 reloaded-divs">
                            ...
                            <select class="selectpicker form-control" name="close_panna" title="Select Panna" id="pre_close_pana" value="">
                                 <option value="">Select</option>
                                <?php foreach ($number as $val) :
                                    $category_idss = $_POST['pana'] ?? '';
                                ?>
