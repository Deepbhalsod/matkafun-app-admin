            ...
            <form class="p-3" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-6">
                            <lable>Panna</lable>
                            <input type="number" class="form-control" id="panna" name="panna" value="<?php echo $ratingssssData['panna']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-6">
                            <lable>Digit</lable>
                            <input type="number" class="form-control" id="digit" name="digit" value="<?php echo $ratingssssData['digit']; ?>">
                        </div>
                    </div>
                </div>
