...
<?php breadcrumb_start('games', 'add/starline', 'starline_game_add'); ?>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
    									    ...
    									    {?>
    									    <a href="<?= SITE_URL; ?>Starline/change_status_gamestarline/<?= $value['id']; ?>/inactive"><span class="badge px-2 py-1 badge-success">Active</span></a>
    									    <?php }else{?>
    									    <a href="<?= SITE_URL; ?>Starline/change_status_gamestarline/<?= $value['id']; ?>/active"><span class="badge px-2 py-1 badge-danger">Inactive</span></a>
    									    <?php }?>
    									</td>
                                        ...
                                        <td>
                                            <ul class="table-controls">
                                                ...
                                                <li>
                                                     <a href="<?php echo SITE_URL . 'edit/starline/' . $value['id'];  ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
