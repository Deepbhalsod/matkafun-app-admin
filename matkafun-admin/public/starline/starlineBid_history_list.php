        ...
        <div class="widget-content widget-content-area br-6">
            ...
            <form method="post">
                <div class="table-responsive mb-4 mt-4">
                    <button id="starline_myrevertFunction">Revert Today Bid</button>
                                    ...
                                    <tr>
                                        ...
                                        <td>                      
                                            <ul class="table-controls">
                                                ...
                                                <li>
                                                     <a href="<?php echo SITE_URL . 'edit_bid/starline/' . $value['id'];  ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
