...
<?php breadcrumb_start('slider', 'list/slider', 'slider_list'); ?>
<div class="row">
        ...
        <div class="statbox widget box box-shadow mt-5">
            ...
            <div class="widget-content widget-content-area">
                <form method="post" enctype="multipart/form-data" id="class_form">
                    ...
                    <button class="btn btn-success mt-3" name="changeSliderStatusCategory" value="sdf" type="submit">Update Status</button>
                </form>
